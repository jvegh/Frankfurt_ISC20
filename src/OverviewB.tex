...
{
	\articleonly{
	Ingnorance in this fields is dangerous: "\textit{In December 2017, PEZY President Motoaki Saito, and PEZY employee, Daisuke Suzuki, were arrested on a charges of fraud – that is – padding expenses}"\footnote{https://en.wikipedia.org/wiki/PEZY\_Computing}.
...
Initially it was communicated that "Aurora was retargeted"\cite{DOEAurora:2017}  and that "DOE Witholds Details of First Exascale Supercomputer, Even as it Solicits Researchers to Apply for Early Access"~\cite{AuroraEarlyScience:2017}.
...
This is expected also be the fate ot the planned EU supercomputers expected to deliver 0.13-0.18~Eflops.	
 The new EU supercomputers are positioned in the "death zone", see Fig.~\ref{fig:EuroHPC}.

The exa-scale race is going on~\cite{ExaSclaRace:2018},
without making the rules of the game clear. This is the target of this tutorial.
	}
